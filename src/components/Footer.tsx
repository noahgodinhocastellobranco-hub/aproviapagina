        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            ...
            <div className="flex gap-6">
              <a href="https://instagram.com/aprovi.a" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors flex items-center gap-1.5">
                <Instagram className="w-4 h-4" />
                Instagram
              </a>
              <a href="https://tiktok.com/@aprovi.a" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors flex items-center gap-1.5">
